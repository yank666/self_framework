...
static void _load_input_meta()
{
  ...
  for (i = 0; i < INPUT_META_NUM; i++)
  {
    ...
    input_meta_tab[i].image.reorder[0] = 0;
    input_meta_tab[i].image.reorder[1] = 1;
    input_meta_tab[i].image.reorder[2] = 2;
    input_meta_tab[i].image.mean[0] = 0.0;
    input_meta_tab[i].image.mean[1] = 0.0;
    input_meta_tab[i].image.mean[2] = 0.0;
    input_meta_tab[i].image.scale = 0.003921569;
  }
  /* lid: input_0_0 */
}
...
vsi_status vnn_PreProcessByPixels
  (
